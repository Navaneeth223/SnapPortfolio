...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        primary:
          'bg-accent-primary text-text-on-accent shadow-sm hover:bg-accent-hover hover:shadow-accent hover:-translate-y-0.5',
        secondary:
          'bg-bg-surface text-text-primary border border-border-default hover:bg-bg-muted',
        outline:
          'border border-border-default bg-transparent hover:bg-bg-muted',
